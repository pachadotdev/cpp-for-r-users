...
// code.cpp
doubles pdist_cpp_(double x, doubles ys);
extern "C" SEXP _ece244_pdist_cpp_(SEXP x, SEXP ys) {
  BEGIN_CPP11
    return cpp11::as_sexp(pdist_cpp_(cpp11::as_cpp<cpp11::decay_t<double>>(x), cpp11::as_cpp<cpp11::decay_t<doubles>>(ys)));
  END_CPP11
}
// code.cpp
